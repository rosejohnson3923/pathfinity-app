-- ================================================================
-- FIX SOCIAL STUDIES NAMING - FINAL VERSION
-- ================================================================
...
-- Now including "Social Studies" with space instead of "SocialStudies"
ALTER TABLE skills_master 
...
-- Step 6: Also update the testing tracker file-based records if needed
UPDATE testing_progress 
SET subject = 'Social Studies' 
WHERE subject = 'SocialStudies';
...
-- Step 8: Verify Grade 10 specifically
SELECT 
...
-- Step 9: Check generation queue
SELECT 
    'Generation Queue' as report_type,
    subject,
    COUNT(*) as count
