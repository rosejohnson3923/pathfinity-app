-- ============================================
-- Common Core Career-Aligned Skills Database Schema (FIXED)
-- ============================================
...
-- INDEXES for performance (FIXED: Added IF NOT EXISTS)
CREATE INDEX IF NOT EXISTS idx_cc_standards_subject_grade ON common_core_standards(subject, grade);
CREATE INDEX IF NOT EXISTS idx_cc_standards_skills_area ON common_core_standards(skills_area);
CREATE INDEX IF NOT EXISTS idx_cc_standards_id ON common_core_standards(common_core_id);

CREATE INDEX IF NOT EXISTS idx_career_mapping_career ON career_standard_mapping(career_code);
CREATE INDEX IF NOT EXISTS idx_career_mapping_standard ON career_standard_mapping(common_core_id);
CREATE INDEX IF NOT EXISTS idx_career_mapping_relevance ON career_standard_mapping(relevance_level);

CREATE INDEX IF NOT EXISTS idx_student_progress_student ON student_common_core_progress(student_id);
CREATE INDEX IF NOT EXISTS idx_student_progress_standard ON student_common_core_progress(common_core_id);
CREATE INDEX IF NOT EXISTS idx_student_progress_status ON student_common_core_progress(status);

CREATE INDEX IF NOT EXISTS idx_career_readiness_student ON career_readiness_scores(student_id);
CREATE INDEX IF NOT EXISTS idx_career_readiness_career ON career_readiness_scores(career_code);

CREATE INDEX IF NOT EXISTS idx_career_content_cache ON career_aligned_content_cache(common_core_id, career_code);
