...
CREATE INDEX idx_student_date ON lesson_archives(student_name, lesson_date DESC);
CREATE INDEX idx_career ON lesson_archives(career_code);
CREATE INDEX idx_status ON lesson_archives(status);
CREATE INDEX idx_lesson_date ON lesson_archives(lesson_date DESC);
...
-- Policies will be added based on your auth structure
-- For now, we'll use basic policies
