...
('chef', 'This career counts ingredients like eggs and cups of flour to make yummy food.', 'counting', 'easy', 'elementary', 0, ARRAY['teacher', 'athlete', 'police-officer'], 'random'),
...
('coach', 'This career reads playbooks with letters and numbers to teach the team strategies.', 'letters', 'easy', 'elementary', 0, ARRAY['athlete', 'sports-analyst', 'referee'], 'related'),
...
-- SEED COMPLETE
-- ================================================================
-- Total clues seeded: 80 (16 careers × 5 clues each)
