...
-- - _archived_dl_* tables (old Career Bingo tables)
-- - _archived_cc_* tables (old Decision Desk tables)
--
...
-- ================================================================
-- STEP 1: Verify current archived tables
-- ================================================================
DO $$
DECLARE
...
-- ================================================================
-- STEP 2: Drop Career Bingo archived tables (_archived_dl_*)
-- ================================================================
...
RAISE NOTICE '✅ Career Bingo archived tables dropped';

-- ================================================================
-- STEP 3: Drop Decision Desk archived tables (_archived_cc_*)
-- ================================================================
...
RAISE NOTICE '✅ Decision Desk archived tables dropped';
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '🎉 SUCCESS! All archived tables have been deleted.';
        RAISE NOTICE '';
