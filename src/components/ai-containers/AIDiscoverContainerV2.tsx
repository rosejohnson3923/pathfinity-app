/**
 * AI-FIRST DISCOVER CONTAINER V2
 * Enhanced version using the DiscoverAIRulesEngine architecture
 * Provides exploration patterns, discovery rewards, and self-directed learning
 */
    ...
    return (
      <>
        ...
        <FloatingLearningDock
          ...
          totalQuestions={phase === 'activities' && content && selectedPath !== null ? 
            content.discovery_paths[selectedPath].activities.length : 0}
    ...
    return (
      <div className="ai-discover-container">
        <div className="loading-state">
          ...
          <p>Powered by Discovery Rules Engine v2</p>
