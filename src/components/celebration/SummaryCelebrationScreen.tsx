/**
 * Summary Celebration Screen Component
 *
 * Glassmorphism-styled celebration for completing all subjects in LEARN/EXPERIENCE containers
 * Shows recap of all subjects with total XP earned
 * Displays before returning to CareerIncLobby
 */

import React, { useEffect, useState } from 'react';
import { motion } from 'framer-motion';
import { Trophy, Star, Zap, CheckCircle, Award } from 'lucide-react';
...
interface SummaryCelebrationScreenProps {
  containerType: 'LEARN' | 'EXPERIENCE';
...
export const SummaryCelebrationScreen: React.FC<SummaryCelebrationScreenProps> = ({
  containerType,
  subjects,
  totalXP,
  studentName,
  ...
  useEffect(() => {
    ...
    // Auto-complete after 6 seconds (longer for summary review)
    if (onComplete) {
  ...
  const containerTitle = containerType === 'LEARN' ? 'Learning Journey' : 'Real-World Experience';
          ...
          <div className="text-center space-y-6">
            ...
            >
              ...
              <p className="text-2xl text-gray-600 dark:text-gray-300">
                You completed your {containerTitle}!
              </p>
            </motion.div>
...
export default SummaryCelebrationScreen;
