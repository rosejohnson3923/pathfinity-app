// Experience Template: Teacher Career - Math Activities
// How teachers use math skills in their daily work

export const teacherMathTemplate = {
  metadata: {
    career: 'teacher',
    careerTitle: 'Teacher',
    subject: 'Math',
  ...
  practiceScenarios: [
    {
      ...
      feedbackIncorrect: "Try again! Teachers must count right!",
      hint: "Count: 1, 2, 3, 4!"
    },
    {
      id: 'scenario-2',
