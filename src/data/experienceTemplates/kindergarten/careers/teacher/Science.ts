// Experience Template: Teacher Career - Science Activities
// How teachers use science skills in their daily work

export const teacherScienceTemplate = {
  metadata: {
    career: 'teacher',
    careerTitle: 'Teacher',
    subject: 'Science',
  ...
  practiceScenarios: [
    ...
    },
    {
      ...
      feedbackIncorrect: "Try again! Teachers help kids feel materials!",
