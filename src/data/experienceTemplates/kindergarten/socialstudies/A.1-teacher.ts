// Experience Template: Kindergarten Social Studies Community - Teacher Career
// Skill: A.1 - Identify community helpers and their roles

export const teacherSocialStudiesKTemplate = {
  metadata: {
    career: 'teacher',
    careerTitle: 'Teacher',
    ...
    commonCoreStandard: 'K.SS.1', // Social Studies standard preserved as metadata
    difficulty: 1,
  ...
  practiceScenarios: [
    ...
    },
    {
      ...
      feedbackIncorrected: "Try again! Teachers help kids learn about safety!",
    ...
    },
    {
      ...
      feedbackIncorrect: "Try again! Teachers help kids learn about mail service!",
  ...
  toolConfiguration: {
    ...
    instructions: "Match helpers! Pick the right helper for each job!",
