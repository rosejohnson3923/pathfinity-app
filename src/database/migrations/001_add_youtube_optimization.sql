-- ============================================================
-- Migration: Add YouTube Search Optimization to skills_master
-- Date: 2025-01-22
...
BEGIN
    ...
    IF p_grade = 'K' THEN
        ...
        age_group := 'for kids';
    ELSIF p_grade::INTEGER <= 2 THEN
        grade_text := p_grade || 'st grade';
        age_group := 'for kids';
    ELSIF p_grade::INTEGER <= 5 THEN
        grade_text := p_grade || 'th grade';
        age_group := 'for kids';
    ELSIF p_grade::INTEGER <= 8 THEN
        grade_text := p_grade || 'th grade';
...
BEGIN
    ...
    IF array_length(key_terms, 1) > 0 THEN
        ...
        -- Variant 4: Educational query
        IF p_grade::INTEGER <= 5 THEN
