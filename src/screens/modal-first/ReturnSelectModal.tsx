/**
 * Return Select Modal - Option Reselection Interface
 * Allows users to return from the lobby to reselect their career and companion choices
 * Self-contained modal system for changing selections within an active session
 */
...
import styles from '../../styles/shared/components/ReturnSelectModal.module.css';
...
export interface ReturnSelectModalProps {
...
export const ReturnSelectModal: React.FC<ReturnSelectModalProps> = ({ 
  onComplete,
  ...
  // Debug logging
  console.log('📊 ReturnSelectModal rendered with:', {
    existingSelections,
    activeSubModal,
    dashboardState,
  ...
  const handleCompanionConfirm = () => {
    if (selectedCompanionTemp) {
      ...
      console.log('🔊 ReturnSelectModal: Playing companion selection confirmation');
      ...
      azureAudioService.playText(confirmText, companionVoice, {
        ...
        onEnd: () => {
          ...
          setTimeout(() => {
            ...
            console.log(`🔊 ReturnSelectModal: Playing part 2 - Continue instruction with ${companionVoice}'s voice`);
  ...
  useEffect(() => {
    if (activeSubModal === 'ai-companion' && !companionAudioPlayedRef.current) {
      ...
      console.log('🔊 ReturnSelectModal: Playing AI Companion selection audio');
            ...
            <div className="header-actions">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  themeService.setTheme(newTheme, 'ReturnSelectModal');
                }}
