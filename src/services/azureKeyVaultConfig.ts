...
interface AzureConfig {
  ...
  cognitiveServicesKeySecondary: string;
  speechKey: string;
...
class AzureKeyVaultConfigService {
  ...
  private useKeyVault = import.meta.env.VITE_USE_KEY_VAULT === 'true';
  private keyVaultName = import.meta.env.VITE_AZURE_KEY_VAULT_NAME || 'pathfinity-dev-kv';
  ...
  private loadFromEnvironment(): AzureConfig {
...
export const azureKeyVaultConfig = new AzureKeyVaultConfigService();
