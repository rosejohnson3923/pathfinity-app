/**
 * Select Lesson Template V3 - Narrative-Driven Format
 *
...
export interface SelectLessonInput {
  student: {
    name: string;
    grade: number;
    currentDate: Date;
...
export class SelectLessonTemplateV3Generator {
  /**
   ...
   */
  async generateDemonstrativeLesson(input: SelectLessonInput): Promise<DemonstrativeLesson> {
    ...
    // Transform to the exact format expected by TestSelectLessonTemplate
...
export const selectLessonTemplateV3 = new SelectLessonTemplateV3Generator();